                     ...
                     int action, int mods)
{
    ...
    case GLFW_KEY_W:
        if (mods == GLFW_MOD_CONTROL)
            switch (action) {   // toggle wireframe
            case GLFW_PRESS:
                wire = not wire;
                if (wire)
    ...
    case GLFW_KEY_SPACE:
        pEye =
            glm::translate(glm::mat4(),
                           glm::vec3(5, 6, 5)) * pSelection[selection];
    ...
    case GLFW_KEY_KP_2:        // move back
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveB[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveB[selection] = false;
            break;
        default:
            return;
        }
    ...
    case GLFW_KEY_KP_4:        // move left
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveL[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveL[selection] = false;
            break;
        default:
            return;
        }
    ...
    case GLFW_KEY_KP_6:        // move right
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveR[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveR[selection] = false;
            break;
        default:
            return;
        }
    ...
    case GLFW_KEY_KP_8:        // move forth
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveF[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveF[selection] = false;
            break;
        default:
            return;
        }
    ...
    case GLFW_KEY_KP_SUBTRACT: // move down
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveD[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveD[selection] = false;
            break;
        default:
            return;
        }
    ...
    case GLFW_KEY_KP_ADD:      // move up
        ...
        case GLFW_PRESS:
        case GLFW_REPEAT:
            selectionMoveU[selection] = true;
            break;
        case GLFW_RELEASE:
            selectionMoveU[selection] = false;
            break;
        default:
            return;
        }
