...
int
 windowX = 0, windowW = DEFAULT_W, windowY = 0, windowH = DEFAULT_H;
...
bool cull = true, wire = false;

glm::vec3 pCursor = glm::vec3(0, 0, 1), vCursor = glm::vec3(0, 0, 1);
...
void initGLFW()
{
    ...
    if (uninitialized) {
        ...
        defaultWindow =
            glfwCreateWindow(DEFAULT_W, DEFAULT_H, &title[0], NULL, NULL);
